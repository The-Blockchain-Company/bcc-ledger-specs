...
\hypersetup{
  pdftitle={Small Step Semantics for Bcc},
  breaklinks=true,
  bookmarks=true,
  colorlinks=false,
  linkcolor={blue},
...
\begin{document}
\title{Small Step Semantics for Bcc}
\author{}
...
defining components of the Bcc cryptocurrency.
\end{abstract}

\section{Introduction}
\label{sec:introduction}

In defining Bcc, we are concerned with the means to construct inductive
