...
module Bcc.Ledger.Example.Translation where
...
--------------------------------------------------------------------------------
-- Translation from Sophie to Example
--
...
type instance PreviousEra (ExampleEra c) = SophieEra c

-- | Currently no context is needed to translate from Sophie to Example.
...
instance Crypto c => TranslateEra (ExampleEra c) SophieGenesis where
