<h1 align="center">Bcc Ledger</h1>

<p align="center">
  <a href="https://buildkite.com/The-Blockchain-Company/bcc-ledger-specs">
  ...
  <a href="https://coveralls.io/github/The-Blockchain-Company/bcc-ledger-specs?branch=master">
    <img alt="Coverage Status" src="https://img.shields.io/coveralls/github/The-Blockchain-Company/bcc-ledger-specs.svg?style=for-the-badge"/>
  </a>
</p>

This repository contains the formal specifications, executable models,
and implementations of the Bcc Ledger.
...
----|------------------|----------------------|-----
Cole | | [Chain Spec](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/coleChainSpec/latest/download-by-type/doc-pdf/blockchain-spec "Specification of the Blockchain Layer"), [Ledger Spec](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/coleLedgerSpec/latest/download-by-type/doc-pdf/ledger-spec "A Formal Specification of the Bcc Ledger") | [CDDL](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/blocksCDDLSpec/latest/download-by-type/doc-pdf/binary)
Sophie | [Design](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/delegationDesignSpec/latest/download-by-type/doc-pdf/delegation_design_spec "Design Specification for Delegation and Incentives in Bcc") | [Spec](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/sophieLedgerSpec/latest/download-by-type/doc-pdf/ledger-spec "A Formal Specification of the Bcc Ledger") | [CDDL](https://github.com/The-Blockchain-Company/bcc-ledger-specs/tree/master/sophie/chain-and-ledger/sophie-spec-ledger-test/cddl-files)
Evie & Jen | [Multi-Currency](https://eprint.iacr.org/2020/895 "Multi-Currency Ledgers"), [UTXOma](https://tbco.io/en/research/library/papers/utxoma-utxo-with-multi-asset-support/ "UTXOma:UTXO with Multi-Asset Support") | [Spec](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/specs.sophie-ma/latest/download-by-type/doc-pdf/sophie-ma "A Formal Specification of the Bcc Ledger with a Native Multi-Asset Implementation") | [CDDL](https://github.com/The-Blockchain-Company/bcc-ledger-specs/tree/master/sophie-ma/sophie-ma-test/cddl-files)
Aurum | [eUTXO](https://tbco.io/en/research/library/papers/the-extended-utxo-model/ "The Extended UTXO Model")| [Spec](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/specs.aurum-ledger/latest/download-by-type/doc-pdf/aurum-changes "A Formal Specification of the Bcc Ledger integrating Zerepoch Core") | [CDDL](https://github.com/The-Blockchain-Company/bcc-ledger-specs/tree/master/aurum/test/cddl-files)

Other Documents:
- [Non-integer calculations specification](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/nonIntegerCalculations/latest/download-by-type/doc-pdf/non-integer-calculations): details on the parts of the Sophie specification that use real numbers.
- [Stake pool ranking specification](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/specs.pool-ranking/latest/download-by-type/doc-pdf/pool-ranking): details for a robust stake pool ranking mechanism.
- [Explanation of the small-step-semantics framework](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/semanticsSpec/latest/download-by-type/doc-pdf/small-step-semantics): a guide to the notation and style used by our ledger rules.

In addition, there is a formalization of the Ledger Specification in Isabelle/HOL which can be found [here](https://github.com/The-Blockchain-Company/fm-ledger-formalization).
...
- [cole](./cole)
  - [ledger](./cole/ledger)
    - [formal-spec](./cole/ledger/formal-spec)
    - [executable-spec](./cole/ledger/executable-spec)
    - [implementation](./cole/ledger/impl)
  - [chain](./cole/chain)
    - [formal-spec](./cole/chain/formal-spec)
    - [executable-spec](./cole/chain/executable-spec)
  - [cddl](./cole/cddl-spec)
- [sophie](./sophie)
  - [design-spec](./sophie/design-spec)
  - [chain-and-ledger](./sophie/chain-and-ledger) (specs are combined in Sophie era)
    - [formal-spec](./sophie/chain-and-ledger/formal-spec)
    - [implementation](./sophie/chain-and-ledger/executable-spec)
    - [tests](./sophie/chain-and-ledger/sophie-spec-ledger-test)
    - [dependencies](./sophie/chain-and-ledger/dependencies)
  - [cddl](./sophie/chain-and-ledger/sophie-spec-ledger-test/cddl-files)
- [Timelocks and Multi-Assets](./sophie-ma)
    - [formal-spec](./sophie-ma/formal-spec)
    - [implementation](./sophie-ma/impl)
    - [tests](./sophie-ma/sophie-ma-test)
...
`cole/ledger/formal-spec` for the ledger specification corresponding to
...
For example the Sophie tests can be run with:

```shell
cabal test sophie-spec-ledger-test
```

**Note** that the tests in `sophie-spec-ledger-test` require two Ruby gems,
...
2. Add the project to the [top-level stack.yaml](./stack.yaml), configuring
   ...
   ``bcc-prelude`](https://github.com/The-Blockchain-Company/bcc-prelude/blob/master/snapshot.yaml),
...
4. Run [nix-shell ./nix -A tbcoNix.stack-cabal-sync-shell --run scripts/stack-cabal_config_check.sh](./scripts/stack-cabal_config_check.sh)
...
from [the Sophie ledger spec](./sophie/chain-and-ledger/formal-spec)).
...
- [The haskell.nix user guide](https://github.com/The-Blockchain-Company/haskell.nix/blob/documentation/docs/user-guide.md)
- [The nix-tools repository](https://github.com/The-Blockchain-Company/nix-tools)
- [The tbco-nix repository](https://github.com/The-Blockchain-Company/tbco-nix)

Note that the user guide linked above is incomplete and does not correctly refer
to projects built using `tbco-nix`, as this one is. A certain amount of trial
and error may be required to make substantive changes!

<p align="center">
  <a href="https://github.com/The-Blockchain-Company/bcc-ledger-specs/blob/master/LICENSE">
    <img src="https://img.shields.io/github/license/The-Blockchain-Company/bcc-ledger-specs.svg?style=for-the-badge"/>
  </a>
</p>
...
There is a script [here](https://github.com/The-Blockchain-Company/bcc-ledger-specs/blob/master/scripts/ormolise.sh)
