...
\DeliverableTitle{A Formal Specification of the Bcc Ledger integrating Zerepoch Core}{Formal Spec: Bcc Ledger with Zerepoch Core}
\DeliverableResponsible{}
\EditorName{TBCO}
\Authors{
   Robert Mourey Jr \quad \texttt{dev@blockchain-company.io}}
...
\newcommand{\ZerepochVI}{\type{ZerepochV1}}
\newcommand{\ZerepochVII}{\type{ZerepochV2}}
