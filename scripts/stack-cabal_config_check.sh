...
HELP_TEXT="bcc-repo-tool not found. Please add it to your PATH, either\n\n\
[1] installing it from \
https://github.com/The-Blockchain-Company/bcc-repo-tool\n\
[2] (usually for CI) using nix-shell from tbco-ops to bring it in scope: \
https://github.com/The-Blockchain-Company/tbco-nix/blob/\
91febccdb615c365dbbda03a9adcaffbafa57846/docs/buildkite-scripts.md"
type bcc-repo-tool &>/dev/null || { echo "${HELP_TEXT}"; exit 1; }
...
\`bcc-repo-tool update-cabal-project\` locally will modify \
