...
\Authors{Philipp Kant   \quad \texttt{<philipp.kant@tbco.io>}
   \\[1em]
   Lars Br\"unjes \quad \texttt{<lars.bruenjes@tbco.io>}
   \\[1em]
   Duncan Coutts  \quad \texttt{<duncan.coutts@tbco.io>}
}
...
\author{Philipp Kant   \\ {\small \texttt{philipp.kant@tbco.io}} \\
   \and Lars Br\"unjes \\ {\small \texttt{lars.bruenjes@tbco.io}} \\
