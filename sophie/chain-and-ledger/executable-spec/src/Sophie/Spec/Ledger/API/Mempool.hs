...
-- | Interface to the Sophie ledger for the purposes of managing a Sophie
-- mempool.
module Sophie.Spec.Ledger.API.Mempool
  ( ApplyTx (..),
    ApplyTxError (..),
    Validated,
    extractTx,
...
import Sophie.Spec.Ledger.STS.Ledger (LedgerEnv, LedgerPredicateFailure)
import qualified Sophie.Spec.Ledger.STS.Ledger as Ledger
...
instance OptimumCrypto c => ApplyTx (SophieEra c)
