...
module Sophie.Spec.Ledger.STS.Upec where

import Bcc.Ledger.BaseTypes (Globals (..), SophieBase, StrictMaybe)
...
instance
  ...
  type BaseM (UPEC era) = SophieBase
