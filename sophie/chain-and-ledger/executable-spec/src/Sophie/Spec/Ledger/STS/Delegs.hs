...
module Sophie.Spec.Ledger.STS.Delegs
  ( DELEGS,
    DelegsEnv (..),
...
import Sophie.Spec.Ledger.STS.Delpl (DELPL, DelplEnv (..), DelplEvent, DelplPredicateFailure)
...
instance
  ...
  type BaseM (DELEGS era) = SophieBase
  type
