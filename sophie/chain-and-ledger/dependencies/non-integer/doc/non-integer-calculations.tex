...
\Authors{Matthias G\"udemann \quad \texttt{<matthias.gudemann@blockchain-company.io>}
}
...
\author{Matthias G\"udemann  \\ {\small \texttt{matthias.gudemann@blockchain-company.io}}}
