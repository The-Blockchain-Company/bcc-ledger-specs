...
\Authors{Jared Corduan \quad \texttt{<jared.corduan@blockchain-company.io>}
   \\[1em]
   Polina Vinogradova \quad \texttt{<polina.vinogradova@blockchain-company.io>}
   \\[1em]
   Matthias G\"udemann \quad \texttt{<matthias.gudemann@blockchain-company.io>}
}
