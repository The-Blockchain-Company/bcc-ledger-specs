...
\EditorName{Robert \"Mourey Jr, \TBCO}
\Authors{Robert Mourey Jr \quad \texttt{<rmourey_jr@blockchain-company.io>}
   \\[1em]
}
...
\author{Jared Corduan  \\ {\small \texttt{jared.corduan@blockchain-company.io}} \\
   \and Matthias G\"udemann  \\ {\small \texttt{matthias.gudemann@blockchain-company.io}}}
