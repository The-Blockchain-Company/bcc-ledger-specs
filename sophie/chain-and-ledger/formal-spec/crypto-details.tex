...
The \fun{sign} and \fun{verify} functions from Figure~\ref{fig:crypto-defs-sophie}
use Ed25519. See \cite{rfcEdDSA}.

\subsection{KES}
The \fun{sign_{ev}} and \fun{verify_{ev}} functions from Figure~\ref{fig:kes-defs-sophie}
