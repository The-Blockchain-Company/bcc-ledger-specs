...
module Test.Sophie.Spec.Ledger.Serialisation.Tripping.CBOR
  ( tests,
...
import qualified Test.Sophie.Spec.Ledger.ConcreteCryptoTypes as Mock
...
prop_roundtrip_SophieGenesis :: SophieGenesis Mock.C -> Property
prop_roundtrip_SophieGenesis = roundtrip toCBOR fromCBOR
...
tests =
  testGroup
    ...
    [ testProperty "roundtrip Block" prop_roundtrip_Block,
      ...
      testProperty "roundtrip Sophie Genesis" prop_roundtrip_SophieGenesis,
