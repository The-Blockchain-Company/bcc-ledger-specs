...
module Test.Sophie.Spec.Ledger.STSTests
  ( chainExamples,
    multisigExamples,
  )
where
...
import Bcc.Ledger.Credential (pattern ScriptHashObj)
import Bcc.Ledger.Keys (asWitness, hashKey, vKey)
import Data.Either (isRight)
import qualified Data.Map.Strict as Map
import qualified Data.Set as Set
import Sophie.Spec.Ledger.LedgerState (WitHashes (..))
import Sophie.Spec.Ledger.STS.Utxow (UtxowPredicateFailure (..))
import Sophie.Spec.Ledger.Tx (hashScript)
import Sophie.Spec.Ledger.TxBody (RewardAcnt (..), Wdrl (..))
import Test.Sophie.Spec.Ledger.ConcreteCryptoTypes (C, C_Crypto)
import Test.Sophie.Spec.Ledger.Examples (testCHAINExample)
import qualified Test.Sophie.Spec.Ledger.Examples.Cast as Cast
import Test.Sophie.Spec.Ledger.Examples.EmptyBlock (exEmptyBlock)
import Test.Sophie.Spec.Ledger.Examples.GenesisDelegation (genesisDelegExample)
import Test.Sophie.Spec.Ledger.Examples.Mir (mirExample)
import Test.Sophie.Spec.Ledger.Examples.MirTransfer (testMIRTransfer)
import Test.Sophie.Spec.Ledger.Examples.NetworkID (testPoolNetworkId)
import Test.Sophie.Spec.Ledger.Examples.PoolLifetime (poolLifetimeExample)
import Test.Sophie.Spec.Ledger.Examples.PoolReReg (poolReRegExample)
import Test.Sophie.Spec.Ledger.Examples.TwoPools (twoPoolsExample)
import Test.Sophie.Spec.Ledger.Examples.Updates (updatesExample)
import Test.Sophie.Spec.Ledger.MultiSigExamples
  ( aliceAndBob,
    aliceAndBobOrCarl,
