...
-- |
-- Module      : Test.Sophie.Spec.Ledger.Examples.Cast
-- Description : Cast of characters for Sophie ledger examples
--
-- The cast of Characters for Sophie Ledger Examples
-- (excluding the genesis/cord nodes,
-- which are in Test.Sophie.Spec.Ledger.Examples.Federation).
module Test.Sophie.Spec.Ledger.Examples.Cast
  ( alicePay,
    aliceStake,
    aliceSHK,
