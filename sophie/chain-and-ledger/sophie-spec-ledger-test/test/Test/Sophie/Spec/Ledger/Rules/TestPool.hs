...
module Test.Sophie.Spec.Ledger.Rules.TestPool
  ( poolRegistration,
...
import Sophie.Spec.Ledger.Delegation.Certificates (PoolCert (RegPool, RetirePool))
...
import Sophie.Spec.Ledger.TxBody (DCert (DCertPool), PoolParams (..))
