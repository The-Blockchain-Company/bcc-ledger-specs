module Test.Sophie.Spec.Ledger.Generator.Constants
  ( Constants (..),
    defaultConstants,
  )
where
...
data Constants = Constants
  { -- | minimal number of transaction inputs to select
    ...
    -- | Relative frequency of generated vested delegation certificates
    frequencyVestedDelegationCert :: Int,
    ...
    -- | minimal number of vested UTxO outputs
    minVestedUTxOouts :: Int,
    -- | maximal number of vested UTxO outputs
    maxVestedUTxOouts :: Int,
    ...
    -- | minimal coin value for generated vested outputs
    minVestedOutputVal :: Integer,
    -- | maximal coin value for generated vested outputs
    maxVestedOutputVal :: Integer,
...
defaultConstants =
  Constants
    { minNumGenInputs = 1,
      ...
      frequencyVestedDelegationCert = 1,
      ...
      minVestedUTxOouts = 10,
      maxVestedUTxOouts = 121,
      maxCertsPerTx = 3,
      maxTxsPerBlock = 10,
      maxNumKeyPairs = 150,
      minGenesisOutputVal = 1000000,
      maxGenesisOutputVal = 100000000,
      minVestedOutputVal = 1000000,
      maxVestedOutputVal = 100000000,
      numBaseScripts = 3,
      numSimpleScripts = 20,
