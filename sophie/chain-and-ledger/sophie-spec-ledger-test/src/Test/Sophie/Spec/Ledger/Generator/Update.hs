...
module Test.Sophie.Spec.Ledger.Generator.Update
  ( genPParams,
    genUpdate,
    genSophiePParamsDelta,
    genM,
...
import qualified Bcc.Ledger.Core as Core (PParams, PParamsDelta)
...
genProtocolVersion = ProtVer <$> genNatural 1 10 <*> genNatural 1 15
...
-- | This is only good in the Sophie Era, used to define the genEraPParamsDelta method for (EraGen (SophieEra c))
genSophiePParamsDelta ::
  forall era.
...
genSophiePParamsDelta (c@Constants {maxMinFeeA, maxMinFeeB}) pp = do
