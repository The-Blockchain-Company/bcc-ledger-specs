...
import Bcc.Binary (Annotated (..), Raw (..), ToCBOR)
import Bcc.Crypto (PassPhrase)
import Bcc.Crypto.Hashing
  ( AbstractHash,
    Hash,
    HashAlgorithm,
    abstractHash,
...
-- | Whilst 'ProtocolMagicId' is represented as a 'Word32' in bcc-ledger,
-- in @bcc-sl@ it was an 'Int32'. In order to tolerate this, and since we
