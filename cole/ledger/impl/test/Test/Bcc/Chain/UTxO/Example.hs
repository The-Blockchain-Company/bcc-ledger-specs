...
module Test.Bcc.Chain.UTxO.Example
  ( exampleTxAux,
    exampleTxAux1,
    exampleTxId,
    exampleTxInList,
...
import Test.Bcc.Crypto.Example (exampleSigningKey, exampleVerificationKey)
...
exampleTxOut1 :: TxOut
exampleTxOut1 = TxOut (makeVerKeyAddress (NetworkTestnet 74) vkey) (mkKnownEntropic @47)
  where
    Right vkey = VerificationKey <$> CC.xpub (getBytes 0 64)
