module Test.Bcc.Chain.Genesis.Gen
...
import Bcc.Crypto (ProtocolMagicId, Signature (..))
...
import Test.Bcc.Chain.UTxO.Gen (genUTxOConfiguration)
...
genFakeAvvmOptions =
  FakeAvvmOptions <$> Gen.word Range.constantBounded <*> genEntropic
...
genGenesisAvvmBalances =
  GenesisAvvmBalances
    <$> customMapGen genCompactRedeemVerificationKey genEntropic
