...
module Test.Bcc.Chain.Elaboration.UTxO
  ( elaborateUTxOEnv,
    elaborateUTxO,
    elaborateTxBody,
    elaborateTxBS,
...
import qualified Cole.Spec.Ledger.STS.UTXO as Abstract
...
import qualified Bcc.Chain.UTxO as Concrete
import qualified Bcc.Chain.UTxO.UTxO as Concrete.UTxO
import qualified Bcc.Chain.UTxO.Validation as Concrete.UTxO
...
import Test.Bcc.Chain.Genesis.Dummy
...
elaborateTxOut abstractTxOut =
  Concrete.TxOut
    { Concrete.txOutAddress =
      ...
      Concrete.txOutValue = entropicValue
    }
  where
    Abstract.TxOut (Abstract.Addr abstractVK) (Abstract.Entropic value) =
      abstractTxOut

    entropicValue = case Concrete.mkEntropic (fromIntegral value) of
