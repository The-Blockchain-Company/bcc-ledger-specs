...
module Test.Bcc.Chain.Buildable
  ( tests,
  )
where
...
import Test.Bcc.Chain.Block.Gen
  ( genBlockSignature,
    genBlockWithEpochSlots,
    genHeader,
  )
import qualified Test.Bcc.Chain.Block.Gen as Block
import qualified Test.Bcc.Chain.Common.Gen as Common
import qualified Test.Bcc.Chain.Delegation.Gen as Delegation
import qualified Test.Bcc.Chain.Genesis.Gen as Genesis
import Test.Bcc.Chain.Slotting.Gen (feedPMEpochSlots)
import qualified Test.Bcc.Chain.Slotting.Gen as Slotting
import qualified Test.Bcc.Chain.UTxO.Gen as UTxO
...
ts_prop_entropicIsBuildable :: TSProperty
ts_prop_entropicIsBuildable = eachOfTS 100 Common.genEntropic isBuildable

ts_prop_entropicPortionIsBuildable :: TSProperty
ts_prop_entropicPortionIsBuildable =
  eachOfTS 100 Common.genEntropicPortion isBuildable
