...
-- | CBOR encoding utilities needed for the Cole transaction format
module Bcc.Chain.Common.CBOR
  ( -- * CBOR in CBOR

    -- | These utilities are is used in the Cole-era chain encodings in cases
    ...
    -- | The Cole era address format includes a CRC to help resist accidental
