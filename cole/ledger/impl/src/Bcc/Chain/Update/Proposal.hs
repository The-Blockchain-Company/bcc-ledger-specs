...
module Bcc.Chain.Update.Proposal
  ( -- * Proposal
    AProposal (..),
    Proposal,
    UpId,
...
import Bcc.Chain.Common.Attributes (dropEmptyAttributes)
import Bcc.Chain.Update.InstallerHash (InstallerHash)
import Bcc.Chain.Update.ProtocolParametersUpdate (ProtocolParametersUpdate)
import Bcc.Chain.Update.ProtocolVersion (ProtocolVersion)
import Bcc.Chain.Update.SoftwareVersion (SoftwareVersion)
import Bcc.Chain.Update.SystemTag (SystemTag)
import Bcc.Crypto
  ( Hash,
    ProtocolMagicId,
    SafeSigner,
