...
import qualified Bcc.Chain.Update.Validation.Interface as U.Iface
...
--
-- <https://github.com/The-Blockchain-Company/bcc-ledger-specs/issues/1046>
-- <https://github.com/The-Blockchain-Company/shardagnostic-network/issues/1291>
applyChainTick ::
  Gen.Config ->
  CC.SlotNumber ->
  CC.ChainValidationState ->
