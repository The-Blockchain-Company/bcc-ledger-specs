...
import Test.Cole.Spec.Ledger.AbstractSize.Properties (testTxHasTypeReps)
import qualified Test.Cole.Spec.Ledger.Core.Generators.Properties as CoreGen
import Test.Cole.Spec.Ledger.Delegation.Examples (deleg)
import qualified Test.Cole.Spec.Ledger.Delegation.Properties as DELEG
import Test.Cole.Spec.Ledger.Relation.Properties (testRelation)
import Test.Cole.Spec.Ledger.UTxO.Properties (moneyIsConstant)
import qualified Test.Cole.Spec.Ledger.UTxO.Properties as UTxO
import Test.Cole.Spec.Ledger.Update.Examples (upiendExamples)
import qualified Test.Cole.Spec.Ledger.Update.Properties as UPDATE
      ...
      localOption Auto $
        testGroup
          ...
          [ testGroup
            ...
            -- systems) and also move the Relation class and instances out of Cole.Spec.Ledger.Core
            testRelation
          ]
