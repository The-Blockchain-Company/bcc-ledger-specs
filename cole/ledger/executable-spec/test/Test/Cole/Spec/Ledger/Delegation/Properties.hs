...
module Test.Cole.Spec.Ledger.Delegation.Properties
  ( dcertsAreTriggered,
...
import Cole.Spec.Ledger.Core.Generators (epochGen, slotGen, vkGen)
import qualified Cole.Spec.Ledger.Core.Generators as CoreGen
import Cole.Spec.Ledger.Delegation
import qualified Cole.Spec.Ledger.Delegation.Test
import Cole.Spec.Ledger.GlobalParams (slotsPerEpoch)
...
invalidSignalsAreGenerated =
  withTests 300 $
    Transition.Generator.invalidSignalsAreGenerated
      ...
      (Cole.Spec.Ledger.Delegation.Test.coverDelegFailures 2)
